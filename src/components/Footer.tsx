      ...
      <div className="max-w-7xl mx-auto px-5 sm:px-8 py-14 sm:py-16">
        <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-10">
          ...
          <div className="lg:col-span-2">
            <div className="font-heading font-[800] text-xl tracking-tight mb-3">
              kreature<span className="text-accent">.</span>
            </div>
          ...
          {FOOTER_LINKS.map((col) => (
            <div key={col.heading}>
              <div className="text-xs uppercase tracking-wider text-dim mb-4">
                {col.heading}
              </div>
